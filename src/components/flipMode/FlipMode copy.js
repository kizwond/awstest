...
class FlipMode extends Component {
  ...
  render() {
    const menu = (
      <Menu>
        <Menu.Item key="0">
          <Button size="small" onClick={this.onClickBack} width="200px">
            <span style={{ fontWeight: "bold" }}>이전</span>
            <span style={{ fontSize: "9px" }}>(이전학습카드로 이동)</span>
          </Button>
        </Menu.Item>
        <Menu.Item key="1">
          <Button size="small" onClick={this.onClickNext} width="200px">
            <span style={{ fontWeight: "bold" }}>통과</span>
            <span style={{ fontSize: "9px" }}>(이번세션에서 제외)</span>
          </Button>
        </Menu.Item>
        {/* <Menu.Divider /> */}
        <Menu.Item key="3">
          <Button size="small" onClick={this.onClickHold} width="200px">
            <span style={{ fontWeight: "bold" }}>보류</span>
            <span style={{ fontSize: "9px" }}>(복구 시까지 학습보류)</span>
          </Button>
        </Menu.Item>
        <Menu.Item key="4">
          <Button size="small" onClick={this.onClickCompleted} width="200px">
            <span style={{ fontWeight: "bold" }}>졸업</span>
            <span style={{ fontSize: "9px" }}>(만렙찍고 향후 학습제외)</span>
          </Button>
        </Menu.Item>
      </Menu>
    );
            ...
            <li style={{ marginRight: "10px", width: "320px" }}>
              <ul>
                ...
                <li style={{ display: "flex", alignItems: "center" }}>
                  <span style={{ marginRight: "10px", width: "40px", fontSize: "11px" }}>학습율</span>
                  <ProgressBar bgcolor={"#a1bbe9"} completed={this.state.study_ratio} />
                </li>
              </ul>
            </li>
            <li>
          ...
          <div style={{ width: "1000px", border: "1px solid lightgrey", borderRadius: "10px" }}>
            ...
            >
              {card_status === "hold" && (
                <Button
                  size="large"
                  onClick={() => this.reStateHold(id_of_content)}
                  style={{ fontSize: "13px", fontWeight: "500", border: "1px solid #bababa", borderRadius: "7px", flex: 1, marginRight: "20px" }}
                >
                  학습중카드로 복구하기
                </Button>
              )}
              {card_status === "completed" && (
                <Button
                  size="large"
                  onClick={() => this.reStateCompleted(id_of_content)}
                  style={{ fontSize: "13px", fontWeight: "500", border: "1px solid #bababa", borderRadius: "7px", flex: 1, marginRight: "20px" }}
                >
                  학습중카드로 복구하기
                </Button>
              ...
              {card_status === "hold" ? (
                ...
                <>
                  <Button
                    size="large"
                    style={{ fontSize: "13px", fontWeight: "500", border: "1px solid #bababa", borderRadius: "7px", width: "120px" }}
                    onClick={() => this.onClickDifficulty("diffi1", id_of_content, book_id, interval[0], time_unit[0], level_revealed)}
                  >
                    {nicks[0]}
                  ...
                  <Button
                    size="large"
                    style={{ fontSize: "13px", fontWeight: "500", border: "1px solid #bababa", borderRadius: "7px", width: "120px" }}
                    onClick={() => this.onClickDifficulty("diffi2", id_of_content, book_id, interval[1], time_unit[1], level_revealed)}
                  >
                    {nicks[1]}
                    <div style={{ marginTop: "-5px", fontSize: "9px" }}>
                      ({interval[1]}
                  ...
                  <Button
                    size="large"
                    style={{ fontSize: "13px", fontWeight: "500", border: "1px solid #bababa", borderRadius: "7px", width: "120px" }}
                    onClick={() => this.onClickDifficulty("diffi3", id_of_content, book_id, interval[2], time_unit[2], level_revealed)}
                  >
                    {nicks[2]}
                    <div style={{ marginTop: "-5px", fontSize: "9px" }}>
                      ({interval[2]}
                  ...
                  <Button
                    size="large"
                    style={{ fontSize: "13px", fontWeight: "500", border: "1px solid #bababa", borderRadius: "7px", width: "120px" }}
                    onClick={() => this.onClickDifficulty("diffi4", id_of_content, book_id, interval[3], time_unit[3], level_revealed)}
                  >
                    {nicks[3]}
                    <div style={{ marginTop: "-5px", fontSize: "9px" }}>
                      ({interval[3]}
                  ...
                  <Button
                    size="large"
                    style={{ fontSize: "13px", fontWeight: "500", border: "1px solid #bababa", borderRadius: "7px", width: "120px" }}
                    onClick={() => this.onClickDifficulty("diffi5", id_of_content, book_id, interval[4], time_unit[4], level_revealed)}
                  >
                    {nicks[4]}
                    <div style={{ marginTop: "-5px", fontSize: "9px" }}>
                      ({interval[4]}
