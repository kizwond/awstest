        ...
        <Form initialValues={initialValues} 
            ...
            <ul>
              ...
              <li>
                ...
                <div>
                  <ul style={style}>
                    <li><Button width="100px" size="small">모르겠음</Button></li>
                ...
                <div>
                  <ul style={style}>
                    <li><Button width="100px" size="small">거의모르겠음</Button></li>
                    <li style={{width:"30px"}}>
                ...
                <div>
                  <ul style={style}>
                    <li><Button width="100px" size="small">애매함</Button></li>
                    <li style={{width:"30px"}}>
                ...
                <div>
                  <ul style={style}>
                    <li><Button width="100px" size="small">거의알겠음</Button></li>
                    <li style={{width:"30px"}}>
                ...
                <div>
                  <ul style={style}>
                    <li><Button width="100px" size="small">알겠음</Button></li>
                    <li style={{width:"30px"}}></li>
                    <li>
