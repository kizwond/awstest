          ...
          <Panel header="페이지 여백" key="3" className="data_collapse_panel">
            <div className="select_page_padding">
              <div className="page_padding_container">
                <div className="padding_top"><Input size='small' onChange={this.onChangePageInnerPaddingTop} value={this.state.pageInnerPaddingTop} style={{ width: 70,fontSize:10 }} type="number"/></div>
                <div className="page_padding_mid_container">
                  <div><Input size='small' style={{ width: 70,fontSize:10 }} onChange={this.onChangePageInnerPaddingLeft} value={this.state.pageInnerPaddingLeft} type="number"/></div>
                  <div className="padding_img_outer">
                    <div>본문</div>
                  </div>
                  <div><Input size='small' style={{ width: 70,fontSize:10 }} onChange={this.onChangePageInnerPaddingRight} value={this.state.pageInnerPaddingRight} type="number"/></div>
                </div>
                <div className="padding_bottom"><Input size='small' onChange={this.onChangePageInnerPaddingBottom} value={this.state.pageInnerPaddingBottom} style={{ width: 70,fontSize:10 }} type="number"/></div>
              </div>
            </div>
          </Panel>
          <Panel header="페이지 색" key="4" className="data_collapse_panel">
            <div className="select_page_color">
              <div className="page_color_picker">
                <div>본문색</div>
                <div><input onChange={this.onChangePageColor} value={this.state.pageColor} type="color"/></div>
              </div>
            </div>
          </Panel>
        </Collapse>
