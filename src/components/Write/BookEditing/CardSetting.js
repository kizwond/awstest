            ...
            <Panel header="카드 테두리 바깥쪽 여백" key="4" className="data_collapse_panel">
              <div className="select_card_margin">
                <div className="card_margin_top">
                   상 <InputNumber size='small' onChange={this.onChangeMarginTop} value={this.state.marginTop} style={{ width: 100,fontSize:10 }} type="number"/>px
                </div>
                <div className="card_margin_mid_container">
                  <div>

                     좌 <InputNumber size='small' onChange={this.onChangeMarginLeft} value={this.state.marginLeft} style={{ width: 100,fontSize:10 }} type="number"/>px
                  ...
                  <div>
                     우 <InputNumber size='small' onChange={this.onChangeMarginRight} value={this.state.marginRight} style={{ width: 100,fontSize:10 }} type="number"/>px
                    
                  </div>
                </div>
                <div className="card_margin_bottom">
                   하 <InputNumber size='small' onChange={this.onChangeMarginBottom} value={this.state.marginBottom} style={{ width: 100,fontSize:10 }} type="number"/>px
                </div>
              </div>
            </Panel>
            <Panel header="카드 테두리 안쪽 여백" key="5" className="data_collapse_panel_numbering">
              <div className="select_card_margin">
                  <div className="card_margin_top">
                     ...
                     상 <InputNumber size='small' onChange={this.onChangePaddingTop} value={this.state.paddingTop} style={{ width: 100,fontSize:10 }} type="number"/>px
                    
                  </div>
                  <div className="card_margin_mid_container">
                    <div>

                       좌 <InputNumber size='small' onChange={this.onChangePaddingLeft} value={this.state.paddingLeft} style={{ width: 100,fontSize:10 }} type="number"/>px
                    ...
                    <div>
                       ...
                       우 <InputNumber size='small' onChange={this.onChangePaddingRight} value={this.state.paddingRight} style={{ width: 100,fontSize:10 }} type="number"/>px
                      
                      </div>
                  </div>
                  <div className="card_margin_bottom">

                     하 <InputNumber size='small' onChange={this.onChangePaddingBottom} value={this.state.paddingBottom} style={{ width: 100,fontSize:10 }} type="number"/>px
              ...
              <div className="card_border_container">
                <div className="select_card_bg_color">
                  ...
                  <div className="card_border_total">
                    ...
                    <div><Input size='small' type="color" onChange={this.onChangeBorderColor} value={this.state.borderColor} style={{width:20}}/></div>
                    <div>

                        <InputNumber size='small' onChange={this.onChangeBorderThickness} value={this.state.borderThickness} style={{ width: 60,fontSize:10, lineHeight: '22px' }} type="number"/>px
