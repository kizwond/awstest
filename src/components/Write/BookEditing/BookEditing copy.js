...
import {StarTwoTone,NumberOutlined} from '@ant-design/icons';
  ...
  render() {
          ...
          if(content[0].type === 'read'){
            ...
            return <><div style={cardStyle} 
                    ...
                    <div><Button 
                      ...
                      {content[0].content.parent_card_id && <>
                        ...
                        <Button size="small" onClick={()=>this.addSiblingCard(content[0].content.parent_card_id)}>형제카드추가</Button></>}</div> 
                      <div> 
                      <Space>   
                        <CardEditing arrayForEditor={this.state.arrayForEditor}
                                     cardTypeDetail={content[0].cardTypeDetail}
            ...
            return <><div style={cardStyle} 
                    ...
                    <div><Button 
                      ...
                      <Button size="small"onClick={this.addChildCard}>자식카드추가</Button>
                      </div>
                      <div>
                      <Space>
                        <CardEditing arrayForEditor={this.state.arrayForEditor}
                                     ...
                                     handleSubmit={this.handleSubmit}
                                     updateContentsState={this.updateContentsState} />
                        {/* <Button size="small" icon={<DeleteOutlined />}>카드 삭제</Button> */}
                        <CardDelete updateCardListState={this.updateCardListState} card_id={content[0].card_id} index_id={this.state.index_id} seq_in_index={content[0].seq_in_index} />
                      </Space>
                      </div>
                    </div>
    ...
    return (
      ...
      <div className="book_writing_container" >
        <div className="left_side_container" style={{marginLeft:toggleLeft, zIndex:"10"}}>
          ...
          <div className="editor_top_menu">
            <div style={{display:'flex', alignItems:'center'}}>
              <Space>
                ...
                <Button size='small' onClick={this.showModal}>카드 이동/삭제</Button>
              </Space>
              <Modal
                title="카드 이동 및 삭제"
        ...
        <Draggable
          ...
          <div style={{border:"1px solid lightgrey", 
            ...
            <div className="handle" style={{cursor:"pointer", width:"100%",height:"20px", border:"1px solid lightgrey", textAlign:"center"}}><NumberOutlined /></div>   
              <Space direction="vertical">
              <h3 style={{marginTop:"5px"}}>카드추가</h3>
